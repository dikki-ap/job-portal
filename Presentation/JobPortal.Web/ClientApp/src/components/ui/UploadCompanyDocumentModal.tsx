...
export function UploadCompanyDocumentModal({ open, onClose, onUpload, isUploading }: Props) {
      ...
      <div className="w-full max-w-md rounded-2xl bg-white shadow-xl">
        <div className="flex items-center justify-between border-b border-gray-100 px-6 py-4">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-base font-semibold text-gray-900">Upload Company Document</h2>
          </div>
          <button
            type="button"
            onClick={handleClose}
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4 p-6">
          <div className="flex flex-col gap-1.5">
            ...
            <input
              ...
              maxLength={100}
              placeholder="e.g. Psychotest Result, MCU Report"
              disabled={isUploading}
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <div
              className="relative flex flex-col items-center justify-center rounded-xl border-2 border-dashed border-gray-200 bg-gray-50 p-6 text-center hover:border-[var(--primary)] hover:bg-blue-50/30 transition-colors cursor-pointer"
