...
public class GetBrandingSettingQueryHandler(IAppSettingRepository appSettingRepository)
    : IRequestHandler<GetBrandingSettingQuery, BrandingSettingDto>
{
        ...
        GetBrandingSettingQuery request, CancellationToken cancellationToken)
    {
        ...
        return new BrandingSettingDto(companyName, logoUrl, primaryColor, primaryHoverColor,
