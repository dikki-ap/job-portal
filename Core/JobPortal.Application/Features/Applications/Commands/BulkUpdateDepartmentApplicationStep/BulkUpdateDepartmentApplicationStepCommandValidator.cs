...
public class BulkUpdateDepartmentApplicationStepCommandValidator : AbstractValidator<BulkUpdateDepartmentApplicationStepCommand>
{
    public BulkUpdateDepartmentApplicationStepCommandValidator()
    {
        ...
        RuleFor(x => x.DepartmentIds)
            .NotNull().NotEmpty().WithMessage("At least one department ID is required.");
    }
}
