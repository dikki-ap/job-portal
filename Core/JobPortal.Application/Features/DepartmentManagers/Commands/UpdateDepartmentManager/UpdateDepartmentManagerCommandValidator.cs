...
public class UpdateDepartmentManagerCommandValidator : AbstractValidator<UpdateDepartmentManagerCommand>
{
    public UpdateDepartmentManagerCommandValidator(
        ...
        IDepartmentRepository departmentRepository)
    {
        ...
        RuleFor(x => x.Email)
            ...
            .MustAsync(async (cmd, email, ct) => !await repository.ExistsByEmailAsync(email, cmd.Id, ct))
